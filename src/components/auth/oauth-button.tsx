...
export function GoogleOAuthButton({ inviteCode }: { inviteCode?: string }) {
  const supabase = useSupabase();

  const handleGoogleSignIn = async () => {
    // Persist invite code across OAuth redirect
    if (inviteCode) {
      localStorage.setItem("nestsync_invite_code", inviteCode);
    }
